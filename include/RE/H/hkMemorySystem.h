...
namespace RE
{
	...
	public:
		...
		virtual hkResult             GetMemorySnapshot([[maybe_unused]] hkMemorySnapshot& a_snapshot) const { return { hkResultEnum::kFailure }; }                                                                                                                          // 11
		virtual hkResult             GetAllocationCallStack([[maybe_unused]] const void* a_ptr, [[maybe_unused]] std::uint64_t* a_callStack, [[maybe_unused]] std::int32_t& a_stackSize, [[maybe_unused]] std::size_t& a_allocSize) { return { hkResultEnum::kFailure }; }  // 12
		virtual void                 SetHeapScrubValues([[maybe_unused]] std::uint32_t a_allocValue, [[maybe_unused]] std::uint32_t a_freeValue) { return; }                                                                                                                // 13
