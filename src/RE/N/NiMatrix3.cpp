...
namespace RE
{
	...
	inline bool NiMatrix3::ToEulerAnglesXYZ(NiPoint3& a_point) const
	{
		return ToEulerAnglesXYZ(a_point.x, a_point.y, a_point.z);
	}

	inline bool NiMatrix3::ToEulerAnglesXYZ(float& a_x, float& a_y, float& a_z) const
	{
	...
	inline bool NiMatrix3::ToEulerAnglesXZY(float& a_x, float& a_z, float& a_y) const
	{
		using func_t = bool (*)(const NiMatrix3*, float&, float&, float&);
	...
	inline bool NiMatrix3::ToEulerAnglesYXZ(float& a_y, float& a_x, float& a_z) const
	{
		using func_t = bool (*)(const NiMatrix3*, float&, float&, float&);
	...
	inline bool NiMatrix3::ToEulerAnglesYZX(float& a_y, float& a_z, float& a_x) const
	{
		using func_t = bool (*)(const NiMatrix3*, float&, float&, float&);
	...
	inline bool NiMatrix3::ToEulerAnglesZYX(float& a_z, float& a_y, float& a_x) const
	{
		using func_t = bool (*)(const NiMatrix3*, float&, float&, float&);
	...
	inline bool NiMatrix3::ToEulerAnglesZXY(float& a_z, float& a_x, float& a_y) const
	{
		using func_t = bool (*)(const NiMatrix3*, float&, float&, float&);
		static REL::Relocation<func_t> func{ REL::ID(2269824) };
		return func(this, a_z, a_x, a_y);
	}

	inline void NiMatrix3::FromEulerAnglesXYZ(const NiPoint3& a_point)
	{
		FromEulerAnglesXYZ(a_point.x, a_point.y, a_point.z);
	}

	inline void NiMatrix3::FromEulerAnglesXYZ(float a_x, float a_y, float a_z)
	{
	...
	inline void NiMatrix3::FromEulerAnglesXZY(float a_x, float a_z, float a_y)
	{
		using func_t = void (*)(NiMatrix3*, float, float, float);
	...
	inline void NiMatrix3::FromEulerAnglesYXZ(float a_y, float a_x, float a_z)
	{
		using func_t = void (*)(NiMatrix3*, float, float, float);
	...
	inline void NiMatrix3::FromEulerAnglesYZX(float a_y, float a_z, float a_x)
	{
		using func_t = void (*)(NiMatrix3*, float, float, float);
	...
	inline void NiMatrix3::FromEulerAnglesZYX(float a_z, float a_y, float a_x)
	{
		using func_t = void (*)(NiMatrix3*, float, float, float);
	...
	inline void NiMatrix3::FromEulerAnglesZXY(float a_z, float a_x, float a_y)
	{
		using func_t = void (*)(NiMatrix3*, float, float, float);
		static REL::Relocation<func_t> func{ REL::ID(2269825) };
		return func(this, a_z, a_x, a_y);
	}
}
